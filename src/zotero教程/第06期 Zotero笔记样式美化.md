...
>第6期
>zotero的自带笔记可以在高级编辑器中进行样式美化，填入CSS代码之后效果非常好看，对有审美需求的朋友们还是建议看看
>本次推文的目的是帮助大家可以快速上手Zotero笔记的美化，及对应部分进行元素的自定义美化
...
h1 {
    ...
    letter-spacing: 2px;
    /* 保持文字颜色为纯白色 */
    border-left: 10px solid rgba(240, 19, 19, 0.5);
    /* 可以根据需要调整边框颜色 */
...
h2 {
    ...
    letter-spacing: 2px;
    /* 保持文字颜色为纯白色 */
    border-left: 10px solid rgba(102, 204, 153, 0.5);
    /* 可以根据需要调整边框颜色 */
...
修改比较复杂，需要自行学习CSS相关知识

## 其它注意事项

笔者也是刚刚进入CSS学习，使用查字典的方式完成了这个代码。中间存在着很多的不优雅的地方和简陋，希望大家谅解
